...
import com.corbettcode.mymovies.domain.model.TimeWindows
...
data class HomeState(
    ...
    val trendingList: List<TmdbResult>? = null,
    val discoverBackgroundPath: String? = null,
    val discoverList: List<TmdbResult>? = null,
    val movieList: List<TmdbResult>? = null,
    val tvSeriesList: List<TmdbResult>? = null,
)

data class ItemsState(
    val itemsList: List<TmdbResult>? = null,
)
